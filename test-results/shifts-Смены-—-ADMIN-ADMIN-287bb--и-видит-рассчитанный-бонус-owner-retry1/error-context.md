...
- Name: shifts.spec.ts >> Смены — ADMIN >> ADMIN создаёт смену и видит рассчитанный бонус
- Location: e2e/shifts.spec.ts:56:7
    ...
    - complementary [ref=e4]:
      ...
      - navigation [ref=e9]:
        ...
        - link "Сотрудники" [ref=e24] [cursor=pointer]:
          ...
          - img [ref=e25]
          - text: Сотрудники
      - paragraph [ref=e30]: Кибер-клуб · 3 филиала
    - main [ref=e32]:
      - generic [ref=e34]:
        - img [ref=e36]
        - heading "Ошибка загрузки смен" [level=2] [ref=e38]
        - paragraph [ref=e39]: Не удалось получить данные по сменам. Проверьте подключение к базе данных.
        - button "Повторить загрузку" [ref=e40]:
          - img
